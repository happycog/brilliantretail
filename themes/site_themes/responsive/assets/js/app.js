...
;$(document).foundation();
// toggle for checkout special instructions
$('#special_instructions').bind('click',function(){
...
$(function(){
    ...
    $('#change_pw_link').bind('click',function(){
        ...
        $('.change_pw').slideToggle();
        return false;
    });
    $('#cancel_password').bind('click',function(){
        $(this).hide();
        $('#change_pw_link').show();
        $('.change_pw').slideToggle();
        return false;
...
b,d){return this.bind(b,function(e){var f=c(e.target);if(f.is(a))return d.apply(f,arguments)})}})})(jQuery);;/*! jQuery UI - v1.8.23 - 2012-08-15
