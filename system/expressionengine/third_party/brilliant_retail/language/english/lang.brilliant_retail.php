...
// Orders 
	...
	'br_print_invoice'			=> "View Invoice",
	'br_print_packing_slip'		=> "Download Packing Slip",
	"method" 					=> "Method",
	"card_type" 				=> "Card Type",
	"exp_year"					=> "Expires",
	"cc_num"					=> "Card Number", 
...
// Configuration
	...
	// Site 
		...
		'br_downlaods_s3_access_key' 	=> 'S3 Access Key', 
		'br_downlaods_s3_secret_key' 	=> 'S3 Secret Key', 
		'br_download_source'			=> 'Source', 
		'br_downlaods_s3_length'		=> 'S3 Link Expires',
		'br_downlaods_s3_length_description' 	=> 'Enter the length of time in minutes that the link is valid for.',
