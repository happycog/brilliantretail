<?php
	...
	*/
	...
	class AssurePay
	{
		...
		var $sDirectoryRequestUrl = 'ssl://www.sisow.nl:443/Sisow/iDeal/RestHandler.ashx/DirectoryRequest';
		var $sTransactionRequestUrl = 'ssl://www.sisow.nl:443/Sisow/iDeal/RestHandler.ashx/TransactionRequest';
		var $sStatusRequestUrl = 'ssl://www.sisow.nl:443/Sisow/iDeal/RestHandler.ashx/StatusRequest';
		...
		function setMerchant($sMerchantId, $sMerchantKey, $sShopId = '')
		{
		...
		function doIssuerRequest($bSelectList = false)
		{
			$sCacheFile = false;
			...
			// Load issuers from AssurePay server
			$this->aIssuers = array();
		...
		function doTransactionRequest($sIssuerId, $sPurchaseId, $fPurchaseAmount, $sPurchaseDescription, $sEntranceCode, $sReturnUrl, $sCallbackUrl = '')
		{
			$this->sTransactionId = false;
			$this->sTransactionUrl = false;
		...
		function doStatusRequest($sTransactionId, $sTransactionCode = false, $sTransactionStatus = false, $sSignature = false)
		{
			$this->sTransactionStatus = false;
		...
		function postToHost($sUrl, $sPostData = false, $bRemoveHeaders = false, $iTimeout = 30)
		{
			$aUrl = parse_url($sUrl);
