...
// Add field to the cart to 'hide with token'
$this->EE->dbforge->add_column('br_cart', array('token' => array(
																	'type' => 'VARCHAR', 
				    	                                            'constraint' => '150',
				    	                                            'null' => TRUE
			        	                                       	)));
...
$sql[] = "DELETE FROM exp_br_zone WHERE zone_id IN (91,111,145,183, 187, 194)";

// Reset key value on states
